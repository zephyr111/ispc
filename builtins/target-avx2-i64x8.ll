...
include(`target-avx1-i64x8base.ll')
...
;; declare <8 x i32> @llvm.x86.avx2.pminsd.256(<8 x i32>, <8 x i32>) nounwind readnone
;; declare <8 x i32> @llvm.x86.avx2.pmaxsd.256(<8 x i32>, <8 x i32>) nounwind readonly

define <8 x i32> @__min_varying_int32(<8 x i32>, <8 x i32>) nounwind readonly alwaysinline {
  %m = call <8 x i32> @llvm.x86.avx2.pminsd.256(<8 x i32> %0, <8 x i32> %1)
  ret <8 x i32> %m
}

define <8 x i32> @__max_varying_int32(<8 x i32>, <8 x i32>) nounwind readonly alwaysinline {
  %m = call <8 x i32> @llvm.x86.avx2.pmaxsd.256(<8 x i32> %0, <8 x i32> %1)
  ret <8 x i32> %m
}
...
;; declare <8 x i32> @llvm.x86.avx2.pminud.256(<8 x i32>, <8 x i32>) nounwind readonly
;; declare <8 x i32> @llvm.x86.avx2.pmaxud.256(<8 x i32>, <8 x i32>) nounwind readonly

define <8 x i32> @__min_varying_uint32(<8 x i32>, <8 x i32>) nounwind readonly alwaysinline {
  %m = call <8 x i32> @llvm.x86.avx2.pminud.256(<8 x i32> %0, <8 x i32> %1)
  ret <8 x i32> %m
}

define <8 x i32> @__max_varying_uint32(<8 x i32>, <8 x i32>) nounwind readonly alwaysinline {
  %m = call <8 x i32> @llvm.x86.avx2.pmaxud.256(<8 x i32> %0, <8 x i32> %1)
  ret <8 x i32> %m
}
...
define <8 x float> @__half_to_float_varying(<8 x i16> %v) nounwind readnone {
  %retval = call <8 x float> @llvm.x86.vcvtph2ps.256(<8 x i16> %v)
  ret <8 x float> %retval
}

define <8 x i16> @__float_to_half_varying(<8 x float> %v) nounwind readnone {
  %retval = call <8 x i16> @llvm.x86.vcvtps2ph.256(<8 x float> %v, i32 0)
  ret <8 x i16> %retval
}
