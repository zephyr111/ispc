...
define <8 x float> @__rcp_varying_float(<8 x float>) nounwind readonly alwaysinline {
  ...
  %two_minus = fsub <8 x float> <float 2., float 2., float 2., float 2., float 2., float 2., float 2., float 2.>, %v_iv
...
define i64 @__movmsk(<8 x i64>) nounwind readnone alwaysinline {
  %doublemask = bitcast <8 x i64> %0 to <8 x double>
  %mask0 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v0 = call i32 @llvm.x86.avx.movmsk.pd.256(<4 x double> %mask0) nounwind readnone
  %mask1 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %v1 = call i32 @llvm.x86.avx.movmsk.pd.256(<4 x double> %mask1) nounwind readnone

  %v1shift = shl i32 %v1, 4
  %v = or i32 %v1shift, %v0
  %v64 = zext i32 %v to i64
  ret i64 %v64
}

define i1 @__any(<8 x i64>) nounwind readnone alwaysinline {
  %doublemask = bitcast <8 x i64> %0 to <8 x double>
  %mask0 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v0 = call i32 @llvm.x86.avx.movmsk.pd.256(<4 x double> %mask0) nounwind readnone
  %mask1 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
define i1 @__all(<8 x i64>) nounwind readnone alwaysinline {
  %doublemask = bitcast <8 x i64> %0 to <8 x double>
  %mask0 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v0 = call i32 @llvm.x86.avx.movmsk.pd.256(<4 x double> %mask0) nounwind readnone
  %mask1 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
define i1 @__none(<8 x i64>) nounwind readnone alwaysinline {
  %doublemask = bitcast <8 x i64> %0 to <8 x double>
  %mask0 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %v0 = call i32 @llvm.x86.avx.movmsk.pd.256(<4 x double> %mask0) nounwind readnone
  %mask1 = shufflevector <8 x double> %doublemask, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
...
define <8 x i32> @__masked_load_i32(i8 *, <8 x i64> %mask64) nounwind alwaysinline {
  %mask      = trunc <8 x i64> %mask64 to <8 x i32>
...
define <8 x i64> @__masked_load_i64(i8 *, <8 x i64> %mask) nounwind alwaysinline {
  %doublemask = bitcast <8 x i64> %mask to <8 x MdORi64>
  %mask0 = shufflevector <8 x i64> %mask, <8 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %mask1 = shufflevector <8 x i64> %mask, <8 x i64> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %mask0d = bitcast <4 x i64> %mask0 to <4 x MdORi64>
  %mask1d = bitcast <4 x i64> %mask1 to <4 x MdORi64>
  ...
  %vald = shufflevector <4 x double> %val0d, <4 x double> %val1d, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %retval = bitcast <8 x double> %vald to <8 x i64>
  ret <8 x i64> %retval
}
...
define void @__masked_store_i32(<8 x i32>* nocapture, <8 x i32>, 
                                <8 x i64>) nounwind alwaysinline {
  %mask32 = trunc <8 x i64> %2 to <8 x i32>

  %ptr    = bitcast <8 x i32> * %0 to i8 *
  %val    = bitcast <8 x i32> %1 to <8 x float>
  %mask   = bitcast <8 x i32> %mask32 to <8 x MfORi32>
...
define void @__masked_store_i64(<8 x i64>* nocapture, <8 x i64>,
                                <8 x i64>) nounwind alwaysinline {
  %ptr0  = bitcast <8 x i64> * %0 to i8 *
  %val0 = shufflevector <8 x i64> %1, <8 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %val1 = shufflevector <8 x i64> %1, <8 x i64> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %mask0 = shufflevector <8 x i64> %2, <8 x i64> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %mask1 = shufflevector <8 x i64> %2, <8 x i64> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %val0d  = bitcast <4 x i64> %val0 to <4 x double>
  %val1d  = bitcast <4 x i64> %val1 to <4 x double>
  %mask0d = bitcast <4 x i64> %mask0 to <4 x MdORi64>
  %mask1d = bitcast <4 x i64> %mask1 to <4 x MdORi64>
  %ptr1 = getelementptr PTR_OP_ARGS(`i8') %ptr0, i32 32
  call void @llvm.x86.avx.maskstore.pd.256(i8 * %ptr0, <4 x MdORi64> %mask0d, <4 x double> %val0d)
  call void @llvm.x86.avx.maskstore.pd.256(i8 * %ptr1, <4 x MdORi64> %mask1d, <4 x double> %val1d)
  ret void
}
...
define void @__masked_store_blend_i32(<8 x i32>* nocapture, <8 x i32>, 
                                      <8 x i64>) nounwind alwaysinline {
  %mask          = trunc   <8 x i64> %2 to <8 x i32>
...
define void @__masked_store_blend_i64(<8 x i64>* nocapture , <8 x i64>,
  ...
  %mask_as_double = bitcast <8 x i64>  %2 to <8 x double>
  %oldValue       = load PTR_OP_ARGS(`<8 x i64>')  %0, align 8
  %oldAsDouble    = bitcast <8 x i64>  %oldValue to <8 x double>
  %newAsDouble    = bitcast <8 x i64>  %1 to <8 x double>
  %oldAsDouble0 = shufflevector <8 x double> %oldAsDouble, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %oldAsDouble1 = shufflevector <8 x double> %oldAsDouble, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %newAsDouble0 = shufflevector <8 x double> %newAsDouble, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %newAsDouble1 = shufflevector <8 x double> %newAsDouble, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %mask_as_double0 = shufflevector <8 x double> %mask_as_double, <8 x double> undef, <4 x i32> <i32 0, i32 1, i32 2, i32 3>
  %mask_as_double1 = shufflevector <8 x double> %mask_as_double, <8 x double> undef, <4 x i32> <i32 4, i32 5, i32 6, i32 7>
  %blend0         = call    <4 x double> @llvm.x86.avx.blendv.pd.256(<4 x double> %oldAsDouble0,
                                                                        <4 x double> %newAsDouble0,
                                                                        <4 x double> %mask_as_double0)
  %blend1         = call    <4 x double> @llvm.x86.avx.blendv.pd.256(<4 x double> %oldAsDouble1,
                                                                        <4 x double> %newAsDouble1,
                                                                        <4 x double> %mask_as_double1)
  %blend = shufflevector <4 x double> %blend0, <4 x double> %blend1, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %blendAsInt = bitcast <8 x double> %blend to <8 x i64>
  store <8 x i64> %blendAsInt, <8 x i64>* %0, align 8
  ret void
}
